...
MySQL - 5.0.27-community-nt-log : Database - penggajian_karyawan
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`penggajian_karyawan` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `tbl_karyawan`(`nik`,`nama`,`jenis_kelamin`,`agama`,`tanggal_lahir`,`telpon`,`alamat`,`kode_jabatan`) values (144,'Venna Chintiya Sofyani','Perempuan','Islam','1997-11-29','087812345678','JL Z. A Pagar Alam No. 12','Mku'),(245,'Wayan Ahmad Denny','Laki-laki','Islam','1996-12-06','082234569812','JL Yos Sudarso No 20','MOp'),(344,'Astrini Adeswari','Perempuan','Islam','1996-12-01','082288456533','JL Mawar No 45','MPm'),(345,'Vina Putri Agustiyani','Perempuan','Islam','1997-08-19','082198543412','JL Melati No 12','SAk');
...
insert  into `tbl_pengguna`(`id`,`nama`,`level`,`password`) values ('122','tya','kasir','2'),('123','venna','admin','1');
